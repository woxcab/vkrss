...
class FeedWriter
{
     ...
     * Constructor
     *
     * @param $version constant the version constant (RSS1/RSS2/ATOM).
     */
     ...
     *
     * @param $elementArray array array of channels
     * @return void
     */
    ...
    private function printItems()
    {
        foreach ($this->items as $item) {
            ...
            foreach ($thisItems as $feedItem) {
                if ($feedItem['name'] == 'category') {
                    foreach ($feedItem['content'] as $tag) {
                        echo $this->makeNode($feedItem['name'], $tag, $feedItem['attributes']);
                    }
                } else {
...
class FeedItem
{
     ...
     * Constructor
     *
     * @param $version constant    (RSS1/RSS2/ATOM) RSS2 is default.
     */
    function __construct($version = RSS2)
    {
        $this->version = $version;
     ...
     * @param $content string  The content of tag
     * @param $attributes array   Attributes(if any) in 'attrName' => 'attrValue' format
     * @return   void
     */
    public function addElement($elementName, $content, $attributes = null)
    {
        if ($elementName == 'category') {
            if (!array_key_exists('category', $this->elements)) {
                $this->elements[$elementName]['content'] = array($content);
            } else {
                array_push($this->elements[$elementName]['content'], $content);
            }
        } else {
